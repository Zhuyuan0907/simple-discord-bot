...
async def on_message(message):
    ...
    if message.content == '<>invite':
        embed=discord.Embed(title="邀請連結", description="[點我邀請](https://discord.com/api/oauth2/authorize?client_id=965610089371303936&permissions=8&scope=bot)", color=0xfefb41)
        await message.channel.send(embed=embed)
...
client.run('TOKEN') #Token可在Discord Developers中找到